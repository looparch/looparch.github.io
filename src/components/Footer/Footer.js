          ...
          <div className="content has-text-centered">
            <p className="is-size-4 social-links">
              <a
                ...
                rel="noopener"
              >
                <span className="logotype m-4">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" style={svgStyle}>
              ...
              >
                <span className="logotype m-4">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style={svgStyle}>
